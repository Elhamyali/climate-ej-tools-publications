...
For sampling, I am taking **10% of the full dataset (2,170 studies) = 217 studies**. Sampling will be stratified by tool `tool_name`. The entire 217-study subset will be double-coded.
...
1.  **Proportional-only allocation** (217 total).
    ...
    -   Example distribution: EJScreen = 124, CEJST = 79, EJI = 11, CRV = 2, FRI = 1.

2.  **Proportional with a minimum floor** (217 total, MIN = 10).
    ...
    -   Final distribution: EJScreen = 109, CEJST = 73, EJI = 18, CRV = 11, FRI = 6.
...
# Parameters
TOTAL <- nrow(all_tools)               # should be 2170
